...
\begin{itemize}
    ...
    \item Versuchsdaten per API in das System einspeichern zu können
    ...
    \item Softwarequalität durch automatisierte Tests wie Pytest, Playwright sicherstellen
\end{itemize}
\newpage

\subsection{Aufgabenstellung}

Um diesen Zielen gerecht zu werden, wurden folgende Aufgaben definiert, die im Rahmen der Diplomarbeit umgesetzt werden sollen:
