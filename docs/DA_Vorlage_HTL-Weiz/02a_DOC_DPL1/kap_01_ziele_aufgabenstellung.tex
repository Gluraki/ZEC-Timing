...
\begin{itemize}
    \item Renndaten aller Bewerbe zuverlässig erfassen, speichern und auswerten
      \item Versuchsdaten per \gls{API} in das System speichern zu können
...
\begin{itemize}
      \item Entwicklung eines in Microservices aufgeteilten RESTful-\gls{API}-Backends zur Zeiterfassung, Punkteauswertung sowie Team- und Benutzerverwaltung
      ...
      \item Rollenbasierte Zugriffskontrolle auf die Website sowie die \gls{API}-Endpunkte
