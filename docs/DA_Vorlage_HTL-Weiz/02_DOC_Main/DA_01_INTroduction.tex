...
zur Strukturierung oder zur Ideenfindung. Alle daraus entstandenen Inhalte wurden von uns selbst geprüft, überarbeitet und fachlich nachvollzogen.
\\[4\baselineskip]
\end{quote}
...
\thispagestyle{ErsteSeite}
\section{Vorwort}
Das Thema der \gls{DA} wurde von der HTL Weiz ausgegeben. Im Zuge dessen wurde ich von Herrn Prof. Mock auf diese 
...
ich die Arbeit zielgerichtet und erfolgreich durchführen. Ebenso möchte ich meinen Freunden danken, die mich vorallem mit ihrer Faszination am Namen 
der \gls{DA} immer wieder motiviert haben, weiterzumachen. Abschließend gilt der größte Dank meiner Familie. Sie hat mich über mein gesamtes Leben 
