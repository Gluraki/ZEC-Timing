...
os.environ.setdefault("KEYCLOAK_LOGIN_CLIENT_ID", "admin-client")
os.environ.setdefault("KEYCLOAK_LOGIN_CLIENT_SECRET", "secret")
os.environ.setdefault("KEYCLOAK_USER_ADMIN_CLIENT_ID", "admin-client")
os.environ.setdefault("KEYCLOAK_USER_ADMIN_CLIENT_SECRET", "admin-secret")
