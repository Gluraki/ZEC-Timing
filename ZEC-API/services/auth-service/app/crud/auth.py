...
KC_ADMIN_CLIENT_ID = settings.KEYCLOAK_USER_ADMIN_CLIENT_ID
KC_ADMIN_CLIENT_SECRET = settings.KEYCLOAK_USER_ADMIN_CLIENT_SECRET
KC_CLIENT_ID = settings.KEYCLOAK_LOGIN_CLIENT_ID
KC_CLIENT_SECRET = settings.KEYCLOAK_LOGIN_CLIENT_SECRET
